...
<!-- <html lang="en"> -->
  ...
  <body>
       ...
       <p class="lead text-center .text-success" style="color: black;font-family: Helvetica, sans-serif;font-size: 30px;margin-top: 30px;">
        ...
        <form style="width: 500px;margin-left: 450px;" action="php/insert_question.php" method="post">
  ...
  <div class="form-group">
    ...
    <input class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="question">
  </div>
